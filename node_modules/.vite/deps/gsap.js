...
var _gsScope = typeof window !== "undefined" ? window : typeof module !== "undefined" && module.exports && typeof globalThis !== "undefined" ? globalThis : {};
var TweenLite = (function(window2) {
  "use strict";
  var _exports = {}, _doc = window2.document, _globals2 = window2.GreenSockGlobals = window2.GreenSockGlobals || window2;
  if (_globals2.TweenLite) {
    return _globals2.TweenLite;
  }
  var _namespace = function(ns) {
    var a2 = ns.split("."), p4 = _globals2, i2;
    for (i2 = 0; i2 < a2.length; i2++) {
      p4[a2[i2]] = p4 = p4[a2[i2]] || {};
    }
    return p4;
  ...
  })(), a, i, p3, _ticker, _tickerActive, _defLookup = {}, Definition = function(ns, dependencies, func, global2) {
  ...
  p3 = Ease2.prototype;
  p3._calcEnd = false;
  p3.getRatio = function(p4) {
    if (this._func) {
      this._params[0] = p4;
      return this._func.apply(null, this._params);
    }
    var t = this._type, pw = this._power, r = t === 1 ? 1 - p4 : t === 2 ? p4 : p4 < 0.5 ? p4 * 2 : (1 - p4) * 2;
    if (pw === 1) {
      r *= r;
    } else if (pw === 2) {
      r *= r * r;
    ...
    return t === 1 ? 1 - r : t === 2 ? r : p4 < 0.5 ? r / 2 : 1 - r / 2;
  };
  a = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"];
  i = a.length;
  while (--i > -1) {
    p3 = a[i] + ",Power" + i;
    _easeReg(new Ease2(null, null, 1, i), p3, "easeOut", true);
    _easeReg(new Ease2(null, null, 2, i), p3, "easeIn" + (i === 0 ? ",easeNone" : ""));
    _easeReg(new Ease2(null, null, 3, i), p3, "easeInOut");
  }
  _easeMap.linear = gs.easing.Linear.easeIn;
  _easeMap.swing = gs.easing.Quad.easeInOut;
  var EventDispatcher2 = _class("events.EventDispatcher", function(target) {
    this._listeners = {};
    this._eventTarget = target || this;
  });
  p3 = EventDispatcher2.prototype;
  p3.addEventListener = function(type, callback, scope, useParam, priority) {
    priority = priority || 0;
    var list = this._listeners[type], index = 0, listener, i2;
  ...
  p3.removeEventListener = function(type, callback) {
  ...
  p3.dispatchEvent = function(type) {
  ...
  p3 = gs.Ticker.prototype = new gs.events.EventDispatcher();
  p3.constructor = gs.Ticker;
  ...
  p3 = Animation2.prototype;
  p3._dirty = p3._gc = p3._initted = p3._paused = false;
  p3._totalTime = p3._time = 0;
  p3._rawPrevTime = -1;
  p3._next = p3._last = p3._onUpdate = p3._timeline = p3.timeline = null;
  p3._paused = false;
  ...
  _checkTimeout();
  p3.play = function(from, suppressEvents) {
    if (from != null) {
      this.seek(from, suppressEvents);
    }
    return this.reversed(false).paused(false);
  };
  p3.pause = function(atTime, suppressEvents) {
    if (atTime != null) {
      this.seek(atTime, suppressEvents);
    }
    return this.paused(true);
  };
  p3.resume = function(from, suppressEvents) {
    if (from != null) {
      this.seek(from, suppressEvents);
    }
    return this.paused(false);
  };
  p3.seek = function(time, suppressEvents) {
    return this.totalTime(Number(time), suppressEvents !== false);
  };
  p3.restart = function(includeDelay, suppressEvents) {
    return this.reversed(false).paused(false).totalTime(includeDelay ? -this._delay : 0, suppressEvents !== false, true);
  };
  p3.reverse = function(from, suppressEvents) {
    if (from != null) {
      this.seek(from || this.totalDuration(), suppressEvents);
    }
    return this.reversed(true).paused(false);
  };
  p3.render = function(time, suppressEvents, force) {
  };
  p3.invalidate = function() {
  ...
  p3._kill = function(vars, target) {
    return this._enabled(false, false);
  };
  p3.kill = function(vars, target) {
    this._kill(vars, target);
    return this;
  };
  p3._uncache = function(includeSelf) {
  ...
  p3._swapSelfInParams = function(params) {
  ...
  p3.eventCallback = function(type, callback, params, scope) {
  ...
  p3.totalDuration = function(value) {
    this._dirty = false;
    return !arguments.length ? this._totalDuration : this.duration(value);
  };
  p3.time = function(value, suppressEvents) {
    if (!arguments.length) {
      return this._time;
    }
    if (this._dirty) {
  ...
  p3.totalTime = function(time, suppressEvents, uncapped) {
    if (!_tickerActive) {
      _ticker.wake();
    }
    if (!arguments.length) {
  ...
  p3.progress = p3.totalProgress = function(value, suppressEvents) {
    var duration = this.duration();
    return !arguments.length ? duration ? this._time / duration : this.ratio : this.totalTime(duration * value, suppressEvents);
  };
  p3.startTime = function(value) {
    if (!arguments.length) {
  ...
  p3.endTime = function(includeRepeats) {
    return this._startTime + (includeRepeats != false ? this.totalDuration() : this.duration()) / this._timeScale;
  };
  p3.timeScale = function(value) {
    if (!arguments.length) {
  ...
  p3 = SimpleTimeline2.prototype = new Animation2();
  p3.constructor = SimpleTimeline2;
  p3.kill()._gc = false;
  p3._first = p3._last = p3._recent = null;
  p3._sortChildren = false;
  p3.add = p3.insert = function(child, position, align, stagger) {
    var prevTween, st;
  ...
  p3._remove = function(tween, skipDisable) {
  ...
  var TweenLite2 = _class("TweenLite", function(target, duration, vars) {
    ...
    var css = {}, p4;
    for (p4 in vars) {
      if (!_reservedProps[p4] && (!(p4 in target) || p4 === "transform" || p4 === "x" || p4 === "y" || p4 === "width" || p4 === "height" || p4 === "className" || p4 === "border") && (!_plugins[p4] || _plugins[p4] && _plugins[p4]._autoCSS)) {
        css[p4] = vars[p4];
        delete vars[p4];
      }
    }
  ...
  p3 = TweenLite2.prototype = new Animation2();
  p3.constructor = TweenLite2;
  p3.kill()._gc = false;
  p3.ratio = 0;
  p3._firstPT = p3._targets = p3._overwrittenProps = p3._startAt = null;
  p3._notifyPluginsOfEnabled = p3._lazy = false;
  TweenLite2.version = "2.1.3";
  TweenLite2.defaultEase = p3._ease = new Ease2(null, null, 1, 1);
  ...
  Animation2._updateRoot = TweenLite2.render = function() {
    ...
    if (_ticker.frame >= _nextGCFrame) {
      ...
      for (p4 in _tweenLookup) {
        a2 = _tweenLookup[p4].tweens;
        i2 = a2.length;
        while (--i2 > -1) {
          if (a2[i2]._gc) {
            a2.splice(i2, 1);
        ...
        if (a2.length === 0) {
          delete _tweenLookup[p4];
        }
      }
      p4 = _rootTimeline._first;
      if (!p4 || p4._paused) {
  ...
  p3._init = function() {
    var v = this.vars, op = this._overwrittenProps, dur = this._duration, immediate = !!v.immediateRender, ease = v.ease, startAt = this._startAt, i2, initPlugins, pt, p4, startVars, l;
    if (v.startAt) {
      if (startAt) {
      ...
      if (startAt) {
        ...
        pt = {};
        for (p4 in v) {
          if (!_reservedProps[p4] || p4 === "autoCSS") {
            pt[p4] = v[p4];
          }
        }
        pt.overwrite = 0;
  ...
  p3._initProps = function(target, propLookup, siblings, overwrittenProps, index) {
    var p4, i2, initPlugins, plugin, pt, v;
    if (target == null) {
      return false;
    }
    ...
    for (p4 in this.vars) {
      v = this.vars[p4];
      if (_reservedProps[p4]) {
        if (v) {
          if (v instanceof Array || v.push && _isArray(v)) {
            if (v.join("").indexOf("{self}") !== -1) {
              this.vars[p4] = v = this._swapSelfInParams(v, this);
            }
          }
        }
      } else if (_plugins[p4] && (plugin = new _plugins[p4]())._onInitTween(target, this.vars[p4], this, index)) {
        this._firstPT = pt = { _next: this._firstPT, t: plugin, p: "setRatio", s: 0, c: 1, f: 1, n: p4, pg: 1, pr: plugin._priority, m: 0 };
        ...
        propLookup[p4] = _addPropTween.call(this, target, p4, "get", v, p4, 0, null, this.vars.stringFilter, index);
      }
    }
    if (overwrittenProps) {
  ...
  p3._kill = function(vars, target, overwritingTween) {
    if (vars === "all") {
      vars = null;
    }
    if (vars == null) {
    ...
    var simultaneousOverwrite = overwritingTween && this._time && overwritingTween._startTime === this._startTime && this._timeline === overwritingTween._timeline, firstPT = this._firstPT, i2, overwrittenProps, p4, pt, propLookup, changed, killProps, record, killed;
      ...
      if (propLookup) {
        ...
        for (p4 in killProps) {
          if (pt = propLookup[p4]) {
            ...
            delete propLookup[p4];
          }
          if (record) {
            overwrittenProps[p4] = 1;
          }
        }
  ...
  p3 = TweenPlugin2.prototype;
  TweenPlugin2.version = "1.19.0";
  TweenPlugin2.API = 2;
  p3._firstPT = null;
  p3._addTween = _addPropTween;
  p3.setRatio = _setRatio;
  p3._kill = function(lookup) {
  ...
  p3._mod = p3._roundProps = function(lookup) {
  ...
  _gsDefine.plugin = function(config) {
    ...
    var propName = config.propName, priority = config.priority || 0, overwriteProps = config.overwriteProps, map = { init: "_onInitTween", set: "setRatio", kill: "_kill", round: "_mod", mod: "_mod", initAll: "_onInitAllProps" }, Plugin = _class(
      ...
      config.global === true
    ), p4 = Plugin.prototype = new TweenPlugin2(propName), prop;
    p4.constructor = Plugin;
    Plugin.API = config.API;
    for (prop in map) {
      if (typeof config[prop] === "function") {
        p4[map[prop]] = config[prop];
      }
    }
  ...
  if (a) {
    ...
    for (p3 in _defLookup) {
      if (!_defLookup[p3].func) {
        window2.console.log("GSAP encountered missing dependency: " + p3);
      }
    }
  }
  _tickerActive = false;
...
_gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function() {
  var TimelineLite2 = function(vars) {
    ...
    var self = this, v = self.vars, val, p4;
    self._labels = {};
    ...
    for (p4 in v) {
      ...
      if (_isArray(val)) {
        if (val.join("").indexOf("{self}") !== -1) {
          v[p4] = self._swapSelfInParams(val);
        }
      }
    }
    ...
    var alt = vars.cycle, p4, val;
    for (p4 in alt) {
      val = alt[p4];
      vars[p4] = typeof val === "function" ? val(i, targets[i], targets) : val[i % val.length];
    }
    delete vars.cycle;
  ...
  }, p3 = TimelineLite2.prototype = new SimpleTimeline();
  TimelineLite2.version = "2.1.3";
  TimelineLite2.distribute = _distribute;
  p3.constructor = TimelineLite2;
  p3.kill()._gc = p3._forcingPlayhead = p3._hasPause = false;
  p3.to = function(target, duration, vars, position) {
    var Engine = vars.repeat && _globals2.TweenMax || TweenLite;
    return duration ? this.add(new Engine(target, duration, vars), position) : this.set(target, vars, position);
  };
  p3.from = function(target, duration, vars, position) {
    return this.add((vars.repeat && _globals2.TweenMax || TweenLite).from(target, duration, _defaultImmediateRender(this, vars)), position);
  };
  p3.fromTo = function(target, duration, fromVars, toVars, position) {
    var Engine = toVars.repeat && _globals2.TweenMax || TweenLite;
    toVars = _defaultImmediateRender(this, toVars, fromVars);
    return duration ? this.add(Engine.fromTo(target, duration, fromVars, toVars), position) : this.set(target, toVars, position);
  };
  p3.staggerTo = function(targets, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
  ...
  p3.staggerFrom = function(targets, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
    vars.runBackwards = true;
    return this.staggerTo(targets, duration, _defaultImmediateRender(this, vars), stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
  };
  p3.staggerFromTo = function(targets, duration, fromVars, toVars, stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
    toVars.startAt = fromVars;
    return this.staggerTo(targets, duration, _defaultImmediateRender(this, toVars, fromVars), stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
  };
  p3.call = function(callback, params, scope, position) {
    return this.add(TweenLite.delayedCall(0, callback, params, scope), position);
  };
  p3.set = function(target, vars, position) {
  ...
  p3.add = function(value, position, align, stagger) {
  ...
  p3.append = function(value, offsetOrLabel) {
    return this.add(value, this._parseTimeOrLabel(null, offsetOrLabel, true, value));
  };
  p3.insert = p3.insertMultiple = function(value, position, align, stagger) {
    return this.add(value, position || 0, align, stagger);
  };
  p3.appendMultiple = function(tweens, offsetOrLabel, align, stagger) {
    return this.add(tweens, this._parseTimeOrLabel(null, offsetOrLabel, true, tweens), align, stagger);
  };
  p3.addLabel = function(label, position) {
    this._labels[label] = this._parseTimeOrLabel(position);
    return this;
  };
  p3.addPause = function(position, callback, params, scope) {
  ...
  p3.removeLabel = function(label) {
    delete this._labels[label];
    return this;
  };
  p3.getLabelTime = function(label) {
    return this._labels[label] != null ? this._labels[label] : -1;
  };
  p3._parseTimeOrLabel = function(timeOrLabel, offsetOrLabel, appendIfAbsent, ignore) {
  ...
  p3.seek = function(position, suppressEvents) {
    return this.totalTime(typeof position === "number" ? position : this._parseTimeOrLabel(position), suppressEvents !== false);
  };
  p3.stop = function() {
    return this.paused(true);
  };
  p3.gotoAndPlay = function(position, suppressEvents) {
    return this.play(position, suppressEvents);
  };
  p3.gotoAndStop = function(position, suppressEvents) {
  ...
  p3.getChildren = function(nested, tweens, timelines, ignoreBeforeTime) {
  ...
  p3.getTweensOf = function(target, nested) {
  ...
  p3.shiftChildren = function(amount, adjustLabels, ignoreBeforeTime) {
    ignoreBeforeTime = ignoreBeforeTime || 0;
    var tween = this._first, labels = this._labels, p4;
    while (tween) {
      if (tween._startTime >= ignoreBeforeTime) {
  ...
  p3.rawTime = function(wrapRepeats) {
...
_gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function() {
  var TimelineMax2 = function(vars) {
    ...
    this._dirty = true;
  }, _tinyNum = 1e-8, TweenLiteInternals = TweenLite._internals, _lazyTweens = TweenLiteInternals.lazyTweens, _lazyRender = TweenLiteInternals.lazyRender, _globals2 = _gsScope._gsDefine.globals, _easeNone = new Ease(null, null, 1, 0), p3 = TimelineMax2.prototype = new TimelineLite();
  p3.constructor = TimelineMax2;
  p3.kill()._gc = false;
  ...
  p3.addCallback = function(callback, position, params, scope) {
    return this.add(TweenLite.delayedCall(0, callback, params, scope), position);
  };
  p3.removeCallback = function(callback, position) {
    if (callback) {
      if (position == null) {
  ...
  p3.removePause = function(position) {
    return this.removeCallback(TimelineLite._internals.pauseCallback, position);
  };
  p3.tweenTo = function(position, vars) {
    vars = vars || {};
    var copy = { ease: _easeNone, useFrames: this.usesFrames(), immediateRender: false, lazy: false }, Engine = vars.repeat && _globals2.TweenMax || TweenLite, duration, p4, t;
    for (p4 in vars) {
      copy[p4] = vars[p4];
    }
  ...
  p3.tweenFromTo = function(fromPosition, toPosition, vars) {
    vars = vars || {};
  ...
  p3.getActive = function(nested, tweens, timelines) {
  ...
  p3.getLabelAfter = function(time) {
    if (!time) {
      if (time !== 0) {
        time = this._time;
      }
  ...
  p3.getLabelBefore = function(time) {
    if (time == null) {
      time = this._time;
    }
  ...
  p3.getLabelsArray = function() {
    var a = [], cnt = 0, p4;
    for (p4 in this._labels) {
      a[cnt++] = { time: this._labels[p4], name: p4 };
    }
  ...
  p3.progress = function(value, suppressEvents) {
    return !arguments.length ? this._time / this.duration() || 0 : this.totalTime(this.duration() * (this._yoyo && (this._cycle & 1) !== 0 ? 1 - value : value) + this._cycle * (this._duration + this._repeatDelay), suppressEvents);
  };
  p3.totalProgress = function(value, suppressEvents) {
  ...
  p3.currentLabel = function(value) {
    if (!arguments.length) {
...
_gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function() {
  var _slice = function(a) {
  ...
  }, TweenMax3 = function(target, duration, vars) {
    ...
    this.render = TweenMax3.prototype.render;
  }, _tinyNum = 1e-8, TweenLiteInternals = TweenLite._internals, _isSelector = TweenLiteInternals.isSelector, _isArray = TweenLiteInternals.isArray, p3 = TweenMax3.prototype = TweenLite.to({}, 0.1, {}), _blankArray = [];
  TweenMax3.version = "2.1.3";
  p3.constructor = TweenMax3;
  p3.kill()._gc = false;
  TweenMax3.killTweensOf = TweenMax3.killDelayedCallsTo = TweenLite.killTweensOf;
  TweenMax3.getTweensOf = TweenLite.getTweensOf;
  TweenMax3.lagSmoothing = TweenLite.lagSmoothing;
  TweenMax3.ticker = TweenLite.ticker;
  TweenMax3.render = TweenLite.render;
  TweenMax3.distribute = _distribute;
  p3.invalidate = function() {
    this._yoyo = this.vars.yoyo === true || !!this.vars.yoyoEase;
    this._repeat = this.vars.repeat || 0;
    this._repeatDelay = this.vars.repeatDelay || 0;
  ...
  p3.updateTo = function(vars, resetDuration) {
    var self = this, curRatio = self.ratio, immediate = self.vars.immediateRender || vars.immediateRender, p4;
  ...
  TweenMax3.to = function(target, duration, vars) {
    return new TweenMax3(target, duration, vars);
  };
  TweenMax3.from = function(target, duration, vars) {
    vars.runBackwards = true;
    vars.immediateRender = vars.immediateRender != false;
    return new TweenMax3(target, duration, vars);
  };
  TweenMax3.fromTo = function(target, duration, fromVars, toVars) {
    toVars.startAt = fromVars;
    toVars.immediateRender = toVars.immediateRender != false && fromVars.immediateRender != false;
    return new TweenMax3(target, duration, toVars);
  };
  TweenMax3.staggerTo = TweenMax3.allTo = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
    var a = [], staggerFunc = _distribute(vars.stagger || stagger), cycle = vars.cycle, fromCycle = (vars.startAt || _blankArray).cycle, l, copy, i, p4;
    if (!_isArray(targets)) {
      if (typeof targets === "string") {
        targets = TweenLite.selector(targets) || targets;
      }
    ...
    for (i = 0; i <= l; i++) {
      ...
      if (fromCycle) {
        ...
        for (p4 in vars.startAt) {
          fromCycle[p4] = vars.startAt[p4];
        }
        _applyCycle(copy.startAt, targets, i);
      }
      ...
      a[i] = new TweenMax3(targets[i], duration, copy);
    }
    return a;
  };
  TweenMax3.staggerFrom = TweenMax3.allFrom = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
    vars.runBackwards = true;
    vars.immediateRender = vars.immediateRender != false;
    return TweenMax3.staggerTo(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
  };
  TweenMax3.staggerFromTo = TweenMax3.allFromTo = function(targets, duration, fromVars, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
    toVars.startAt = fromVars;
    toVars.immediateRender = toVars.immediateRender != false && fromVars.immediateRender != false;
    return TweenMax3.staggerTo(targets, duration, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
  };
  TweenMax3.delayedCall = function(delay, callback, params, scope, useFrames) {
    return new TweenMax3(callback, 0, { delay, onComplete: callback, onCompleteParams: params, callbackScope: scope, onReverseComplete: callback, onReverseCompleteParams: params, immediateRender: false, useFrames, overwrite: 0 });
  };
  TweenMax3.set = function(target, vars) {
    return new TweenMax3(target, 0, vars);
  };
  TweenMax3.isTweening = function(target) {
  ...
  var _getChildrenOf = function(timeline, includeTimelines) {
    ...
    return a;
  }, getAllTweens = TweenMax3.getAllTweens = function(includeTimelines) {
    return _getChildrenOf(Animation._rootTimeline, includeTimelines).concat(_getChildrenOf(Animation._rootFramesTimeline, includeTimelines));
  };
  TweenMax3.killAll = function(complete, tweens, delayedCalls, timelines) {
    if (tweens == null) {
      tweens = true;
    }
  ...
  TweenMax3.killChildTweensOf = function(parent, complete) {
    if (parent == null) {
      return;
    }
    var tl = TweenLiteInternals.tweenLookup, a, curParent, p4, i, l;
    ...
    if (_isArray(parent)) {
      i = parent.length;
      while (--i > -1) {
        TweenMax3.killChildTweensOf(parent[i], complete);
      }
      return;
    }
    a = [];
    for (p4 in tl) {
      curParent = tl[p4].target.parentNode;
      while (curParent) {
        if (curParent === parent) {
          a = a.concat(tl[p4].tweens);
        }
  ...
  TweenMax3.pauseAll = function(tweens, delayedCalls, timelines) {
    _changePause(true, tweens, delayedCalls, timelines);
  };
  TweenMax3.resumeAll = function(tweens, delayedCalls, timelines) {
    _changePause(false, tweens, delayedCalls, timelines);
  };
  TweenMax3.globalTimeScale = function(value) {
...
_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function() {
  ...
  }, _globals2 = _gsScope._gsDefine.globals, _hasPriority, _suffixMap, _cs, _overwriteProps, _specialProps = {}, p3 = CSSPlugin2.prototype = new TweenPlugin("css");
  p3.constructor = CSSPlugin2;
  ...
  p3 = "px";
  CSSPlugin2.suffixMap = { top: p3, right: p3, bottom: p3, left: p3, width: p3, height: p3, fontSize: p3, padding: p3, margin: p3, perspective: p3, lineHeight: "" };
  var _numExp = /(?:\-|\.|\b)(\d|\.|e\-)+/g, _relNumExp = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _valuesExp = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, _valuesExpWithCommas = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b),?/gi, _NaNExp = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, _suffixExp = /(?:\d|\-|\+|=|#|\.)*/g, _opacityExp = /opacity *= *([^)]*)/i, _opacityValExp = /opacity:([^;]*)/i, _alphaFilterExp = /alpha\(opacity *=.+?\)/i, _rgbhslExp = /^(rgb|hsl)/, _capsExp = /([A-Z])/g, _camelExp = /-([a-z])/gi, _urlExp = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, _camelFunc = function(s, g) {
  ...
  }, _target, _index, _prefixCSS = "", _prefix = "", _checkPropPrefix = function(p4, e) {
    e = e || _tempDiv;
    var s = e.style, a, i2;
    if (s[p4] !== void 0) {
      return p4;
    }
    p4 = p4.charAt(0).toUpperCase() + p4.substr(1);
    a = ["O", "Moz", "ms", "Ms", "Webkit"];
    i2 = 5;
    while (--i2 > -1 && s[a[i2] + p4] === void 0) {
    }
    if (i2 >= 0) {
  ...
  }, _getStyle = CSSPlugin2.getStyle = function(t, p4, cs, calc, dflt) {
    var rv;
    if (!_supportsOpacity) {
      if (p4 === "opacity") {
    ...
    if (!calc && t.style[p4]) {
      ...
      rv = cs[p4] || cs.getPropertyValue(p4) || cs.getPropertyValue(p4.replace(_capsExp, "-$1").toLowerCase());
    } else if (t.currentStyle) {
      rv = t.currentStyle[p4];
    }
    return dflt != null && (!rv || rv === "none" || rv === "auto" || rv === "auto auto") ? dflt : rv;
  }, _convertToPixels = _internals.convertToPixels = function(t, p4, v, sfx, recurse) {
    if (sfx === "px" || !sfx && p4 !== "lineHeight") {
      return v;
    }
    if (sfx === "auto" || !v) {
      return 0;
    }
    var horiz = _horizExp.test(p4), node = t, style = _tempDiv.style, neg = v < 0, precise = v === 1, pix, cache, time;
    if (neg) {
      v = -v;
    }
    if (precise) {
    ...
    if (p4 === "lineHeight" && !sfx) {
      cache = _getComputedStyle(t).lineHeight;
      t.style.lineHeight = v;
      pix = parseFloat(_getComputedStyle(t).lineHeight);
      t.style.lineHeight = cache;
    } else if (sfx === "%" && p4.indexOf("border") !== -1) {
      ...
      if (pix === 0 && !recurse) {
        pix = _convertToPixels(t, p4, v, sfx, true);
      }
    }
    if (precise) {
      pix /= 100;
    ...
    return neg ? -pix : pix;
  }, _calculateOffset = _internals.calculateOffset = function(t, p4, cs) {
    if (_getStyle(t, "position", cs) !== "absolute") {
      return 0;
    }
    var dim = p4 === "left" ? "Left" : "Top", v = _getStyle(t, "margin" + dim, cs);
    return t["offset" + dim] - (_convertToPixels(t, p4, parseFloat(v), v.replace(_suffixExp, "")) || 0);
    ...
    if (cs = cs || _getComputedStyle(t, null)) {
      if (i2 = cs.length) {
        while (--i2 > -1) {
          p4 = cs[i2];
          if (p4.indexOf("-transform") === -1 || _transformPropCSS === p4) {
            s[p4.replace(_camelExp, _camelFunc)] = cs.getPropertyValue(p4);
          }
        }
      } else {
        for (i2 in cs) {
    ...
    var difs = {}, style = t.style, val, p4, mpt;
    for (p4 in s2) {
      if (p4 !== "cssText") {
        if (p4 !== "length") {
          if (isNaN(p4)) {
            if (s1[p4] !== (val = s2[p4]) || forceLookup && forceLookup[p4]) {
              if (p4.indexOf("Origin") === -1) {
                if (typeof val === "number" || typeof val === "string") {
                  difs[p4] = val === "auto" && (p4 === "left" || p4 === "top") ? _calculateOffset(t, p4) : (val === "" || val === "auto" || val === "none") && typeof s1[p4] === "string" && s1[p4].replace(_NaNExp, "") !== "" ? 0 : val;
                  if (style[p4] !== void 0) {
                    mpt = new MiniPropTween(style, p4, style[p4], mpt);
                  }
                }
              }
            }
  ...
  }, _dimensions = { width: ["Left", "Right"], height: ["Top", "Bottom"] }, _margins = ["marginLeft", "marginRight", "marginTop", "marginBottom"], _getDimension = function(t, p4, cs) {
    if ((t.nodeName + "").toLowerCase() === "svg") {
      return (cs || _getComputedStyle(t))[p4] || 0;
    } else if (t.getCTM && _isSVG(t)) {
      return t.getBBox()[p4] || 0;
    }
    var v = parseFloat(p4 === "width" ? t.offsetWidth : t.offsetHeight), a = _dimensions[p4], i2 = a.length;
  ...
  }, _parseAngle = function(v, d, p4, directionalEnd) {
  ...
  var _getFormatter = function(dflt, clr, collapsible, multi) {
    ...
    props = props.split(",");
    return function(t, e, p4, cssp, pt, plugin, vars) {
      var a = (e + "").split(" "), i2;
      vars = {};
      for (i2 = 0; i2 < 4; i2++) {
    ...
    var d = this.data, proxy = d.proxy, mpt = d.firstMPT, min = 1e-6, val, pt, i2, str, p4;
    while (mpt) {
      val = proxy[mpt.v];
      if (mpt.r) {
        val = mpt.r(val);
  ...
  }, MiniPropTween = function(t, p4, v, next, r) {
    this.t = t;
    this.p = p4;
    this.v = v;
    this.r = r;
    ...
    var bpt = pt, start = {}, end = {}, transform = cssp._transform, oldForce = _forcePT, i2, p4, xp, mpt, firstPT;
    ...
    while (pt && pt !== bpt) {
      if (pt.type <= 1) {
        ...
        start[p4] = pt.s;
        if (!shallow) {
          mpt = new MiniPropTween(pt, "s", p4, mpt, pt.r);
          pt.c = 0;
        }
        if (pt.type === 1) {
          i2 = pt.l;
          while (--i2 > 0) {
            ...
            start[p4] = pt[xp];
            if (!shallow) {
              mpt = new MiniPropTween(pt, xp, p4, mpt, pt.rxp[xp]);
            }
          }
        }
      }
  ...
  }, CSSPropTween = _internals.CSSPropTween = function(t, p4, s, c, next, type, n, r, pr, b, e) {
    this.t = t;
    this.p = p4;
    this.s = s;
    this.c = c;
    ...
    pt.e = pt.xs0 = end;
    return pt;
  }, _parseComplex = CSSPlugin2.parseComplex = function(t, p4, b, e, clrs, dflt, pt, pr, plugin, setRatio) {
    b = b || dflt || "";
    if (typeof e === "function") {
      e = e(_index, _target);
    }
    pt = new CSSPropTween(t, p4, 0, 0, pt, setRatio ? 2 : 1, null, false, pr, b, e);
    e += "";
  ...
  p3.xs0 = "";
  p3._next = p3._prev = p3.xfirst = p3.data = p3.plugin = p3.setRatio = p3.rxp = null;
  p3.appendXtra = function(pfx, s, c, sfx, r, pad) {
    var pt = this, l = pt.l;
  ...
  var SpecialProp = function(p4, options) {
    options = options || {};
    this.p = options.prefix ? _checkPropPrefix(p4) || p4 : p4;
    _specialProps[p4] = _specialProps[this.p] = this;
  ...
  }, _registerComplexSpecialProp = _internals._registerComplexSpecialProp = function(p4, options, defaults) {
    if (typeof options !== "object") {
      options = { parser: defaults };
    }
    var a = p4.split(","), d = options.defaultValue, i2, temp;
    defaults = defaults || [d];
    for (i2 = 0; i2 < a.length; i2++) {
      options.prefix = i2 === 0 && options.prefix;
      options.defaultValue = defaults[i2] || d;
      temp = new SpecialProp(a[i2], options);
    }
  }, _registerPluginProp = _internals._registerPluginProp = function(p4) {
    if (!_specialProps[p4]) {
      var pluginName = p4.charAt(0).toUpperCase() + p4.substr(1) + "Plugin";
      _registerComplexSpecialProp(p4, { parser: function(t, e, p5, cssp, pt, plugin, vars) {
        ...
        return _specialProps[p5].parse(t, e, p5, cssp, pt, plugin, vars);
      } });
    }
  };
  p3 = SpecialProp.prototype;
  p3.parseComplex = function(t, b, e, pt, plugin, setRatio) {
  ...
  p3.parse = function(t, e, p4, cssp, pt, plugin, vars) {
    return this.parseComplex(t.style, this.format(_getStyle(t, this.p, _cs, false, this.dflt)), this.format(e), pt, plugin);
  };
  CSSPlugin2.registerSpecialProp = function(name, onInitTween, priority) {
    _registerComplexSpecialProp(name, { parser: function(t, e, p4, cssp, pt, plugin, vars) {
      var rv = new CSSPropTween(t, p4, 0, 0, pt, 2, p4, false, priority);
      rv.plugin = plugin;
      rv.setRatio = onInitTween(t, e, cssp._tween, p4);
      return rv;
    }, priority });
  };
  ...
  var _transformProps = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), _transformProp = _checkPropPrefix("transform"), _transformPropCSS = _prefixCSS + "transform", _transformOriginProp = _checkPropPrefix("transformOrigin"), _supports3D = _checkPropPrefix("perspective") !== null, Transform = _internals.Transform = function() {
    ...
    var element = _doc.createElementNS("http://www.w3.org/2000/svg", type), reg = /([a-z])([A-Z])/g, p4;
    for (p4 in attributes) {
      element.setAttributeNS(null, p4.replace(reg, "$1-$2").toLowerCase(), attributes[p4]);
    }
  ...
  p3 = Transform.prototype;
  p3.x = p3.y = p3.z = p3.skewX = p3.skewY = p3.rotation = p3.rotationX = p3.rotationY = p3.zOrigin = p3.xPercent = p3.yPercent = p3.xOffset = p3.yOffset = 0;
  p3.scaleX = p3.scaleY = p3.scaleZ = 1;
  _registerComplexSpecialProp("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", { parser: function(t, e, parsingProp, cssp, pt, plugin, vars) {
    ...
    while (--i2 > -1) {
      p4 = _transformProps[i2];
      orig = m2[p4] - m1[p4];
      if (orig > min || orig < -min || v[p4] != null || _forcePT[p4] != null) {
        hasChange = true;
        pt = new CSSPropTween(m1, p4, m1[p4], orig, pt);
        if (p4 in endRotations) {
          pt.e = endRotations[p4];
        }
        pt.xs0 = 0;
        pt.plugin = plugin;
    ...
    if (orig || _supports3D && has3D && m1.zOrigin) {
      if (_transformProp) {
        hasChange = true;
        p4 = _transformOriginProp;
        if (!orig) {
          orig = (_getStyle(t, p4, _cs, false, "50% 50%") + "").split(" ");
          orig = orig[0] + " " + orig[1] + " " + m1.zOrigin + "px";
        }
        orig += "";
        pt = new CSSPropTween(style, p4, 0, 0, pt, -1, transformOriginString);
        pt.b = style[p4];
        pt.plugin = plugin;
        if (_supports3D) {
          copy = m1.zOrigin;
  ...
  _registerComplexSpecialProp("borderRadius", { defaultValue: "0px", parser: function(t, e, p4, cssp, pt, plugin) {
    e = this.format(e);
  ...
  _registerComplexSpecialProp("borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius", { defaultValue: "0px", parser: function(t, e, p4, cssp, pt, plugin) {
    return _parseComplex(t.style, p4, this.format(_getStyle(t, p4, _cs, false, "0px 0px")), this.format(e), false, "0px", pt);
  }, prefix: true, formatter: _getFormatter("0px 0px", false, true) });
  _registerComplexSpecialProp("backgroundPosition", { defaultValue: "0 0", parser: function(t, e, p4, cssp, pt, plugin) {
    var bp = "background-position", cs = _cs || _getComputedStyle(t, null), bs = this.format((cs ? _ieVers ? cs.getPropertyValue(bp + "-x") + " " + cs.getPropertyValue(bp + "-y") : cs.getPropertyValue(bp) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), es = this.format(e), ba, ea, i2, pct, overlap, src;
  ...
  _registerComplexSpecialProp("clip", { defaultValue: "rect(0px,0px,0px,0px)", parser: function(t, e, p4, cssp, pt, plugin) {
    var b, cs, delim;
    if (_ieVers < 9) {
      cs = t.currentStyle;
      delim = _ieVers < 8 ? " " : ",";
  ...
  _registerComplexSpecialProp("autoRound,strictUnits", { parser: function(t, e, p4, cssp, pt) {
    return pt;
  } });
  _registerComplexSpecialProp("border", { defaultValue: "0px solid #000", parser: function(t, e, p4, cssp, pt, plugin) {
  ...
  _registerComplexSpecialProp("float,cssFloat,styleFloat", { parser: function(t, e, p4, cssp, pt, plugin) {
    var s = t.style, prop = "cssFloat" in s ? "cssFloat" : "styleFloat";
    return new CSSPropTween(s, prop, 0, 0, pt, -1, p4, false, 0, s[prop], e);
  } });
  ...
  _registerComplexSpecialProp("opacity,alpha,autoAlpha", { defaultValue: "1", parser: function(t, e, p4, cssp, pt, plugin) {
    var b = parseFloat(_getStyle(t, "opacity", _cs, false, "1")), style = t.style, isAutoAlpha = p4 === "autoAlpha";
    ...
    if (isAutoAlpha) {
      ...
      pt.xs0 = "inherit";
      cssp._overwriteProps.push(pt.n);
      cssp._overwriteProps.push(p4);
    }
    return pt;
  } });
  var _removeProp = function(s, p4) {
    if (p4) {
      if (s.removeProperty) {
        if (p4.substr(0, 2) === "ms" || p4.substr(0, 6) === "webkit") {
          p4 = "-" + p4;
        }
        s.removeProperty(p4.replace(_capsExp, "-$1").toLowerCase());
      } else {
        s.removeAttribute(p4);
      }
    }
  ...
  _registerComplexSpecialProp("className", { parser: function(t, e, p4, cssp, pt, plugin, vars) {
    var b = t.getAttribute("class") || "", cssText = t.style.cssText, difData, bs, cnpt, cnptLookup, mpt;
    pt = cssp._classNamePT = new CSSPropTween(t, p4, 0, 0, pt, 2);
  ...
  var _setClearPropsRatio = function(v) {
    if (v === 1 || v === 0) {
      if (this.data._totalTime === this.data._totalDuration && this.data.data !== "isFromStart") {
        var s = this.t.style, transformParse = _specialProps.transform.parse, a, p4, i2, clearTransform, transform;
        if (this.e === "all") {
          s.cssText = "";
          clearTransform = true;
        } else {
          ...
          while (--i2 > -1) {
            p4 = a[i2];
            if (_specialProps[p4]) {
              if (_specialProps[p4].parse === transformParse) {
                clearTransform = true;
              } else {
                p4 = p4 === "transformOrigin" ? _transformOriginProp : _specialProps[p4].p;
              }
            }
            _removeProp(s, p4);
          }
  ...
  _registerComplexSpecialProp("clearProps", { parser: function(t, e, p4, cssp, pt) {
    pt = new CSSPropTween(t, p4, 0, 0, pt, 2);
  ...
  p3 = "bezier,throwProps,physicsProps,physics2D".split(",");
  i = p3.length;
  while (i--) {
    _registerPluginProp(p3[i]);
  }
  p3 = CSSPlugin2.prototype;
  p3._firstPT = p3._lastParsedTransform = p3._transform = null;
  p3._onInitTween = function(target, vars, tween, index) {
    if (!target.nodeType) {
      return false;
    }
  ...
  p3.parse = function(target, vars, pt, plugin) {
    var style = target.style, p4, sp, bn, en, bs, es, bsfx, esfx, isStr, rel;
    for (p4 in vars) {
      es = vars[p4];
      sp = _specialProps[p4];
      ...
      if (sp) {
        pt = sp.parse(target, es, p4, this, pt, plugin, vars);
      } else if (p4.substr(0, 2) === "--") {
        this._tween._propLookup[p4] = this._addTween.call(this._tween, target.style, "setProperty", _getComputedStyle(target).getPropertyValue(p4) + "", es + "", p4, false, p4);
        continue;
      } else {
        bs = _getStyle(target, p4, _cs) + "";
        isStr = typeof es === "string";
        if (p4 === "color" || p4 === "fill" || p4 === "stroke" || p4.indexOf("Color") !== -1 || isStr && _rgbhslExp.test(es)) {
          if (!isStr) {
            es = _parseColor(es);
            es = (es.length > 3 ? "rgba(" : "rgb(") + es.join(",") + ")";
          }
          pt = _parseComplex(style, p4, bs, es, true, "transparent", pt, 0, plugin);
        } else if (isStr && _complexExp.test(es)) {
          pt = _parseComplex(style, p4, bs, es, true, null, pt, 0, plugin);
        } else {
          bn = parseFloat(bs);
          bsfx = bn || bn === 0 ? bs.substr((bn + "").length) : "";
          if (bs === "" || bs === "auto") {
            if (p4 === "width" || p4 === "height") {
              bn = _getDimension(target, p4, _cs);
              bsfx = "px";
            } else if (p4 === "left" || p4 === "top") {
              bn = _calculateOffset(target, p4, _cs);
              bsfx = "px";
            } else {
              bn = p4 !== "opacity" ? 0 : 1;
              bsfx = "";
          ...
          if (esfx === "") {
            esfx = p4 in _suffixMap ? _suffixMap[p4] : bsfx;
          }
          es = en || en === 0 ? (rel ? en + bn : en) + esfx : vars[p4];
          if (bsfx !== esfx) {
            if (esfx !== "" || p4 === "lineHeight") {
              if (en || en === 0) {
                if (bn) {
                  bn = _convertToPixels(target, p4, bn, bsfx);
                  if (esfx === "%") {
                    bn /= _convertToPixels(target, p4, 100, "%") / 100;
                    if (vars.strictUnits !== true) {
                      bs = bn + "%";
                    }
                  } else if (esfx === "em" || esfx === "rem" || esfx === "vw" || esfx === "vh") {
                    bn /= _convertToPixels(target, p4, 1, esfx);
                  } else if (esfx !== "px") {
                    en = _convertToPixels(target, p4, en, esfx);
                    esfx = "px";
                  }
                  if (rel) {
                    if (en || en === 0) {
          ...
          if ((bn || bn === 0) && (en || en === 0)) {
            pt = new CSSPropTween(style, p4, bn, en - bn, pt, 0, p4, _autoRound !== false && (esfx === "px" || p4 === "zIndex"), 0, bs, es);
            pt.xs0 = esfx;
          } else if (style[p4] === void 0 || !es && (es + "" === "NaN" || es == null)) {
            _log("invalid " + p4 + " tween value: " + vars[p4]);
          } else {
            pt = new CSSPropTween(style, p4, en || bn || 0, 0, pt, -1, p4, false, 0, bs, es);
            pt.xs0 = es === "none" && (p4 === "display" || p4.indexOf("Style") !== -1) ? bs : es;
          }
        }
      }
      if (plugin) {
  ...
  p3._enableTransforms = function(threeD) {
  ...
  p3._addLazySet = function(t, p4, v) {
    var pt = this._firstPT = new CSSPropTween(t, p4, 0, 0, this._firstPT, 2);
    pt.e = v;
    pt.setRatio = lazySet;
    pt.data = this;
  };
  p3._linkCSSP = function(pt, next, prev, remove) {
    if (pt) {
      if (next) {
        next._prev = pt;
      }
  ...
  p3._kill = function(lookup) {
    ...
    pt = this._firstPT;
    while (pt) {
      if (pt.plugin && pt.plugin !== p4 && pt.plugin._kill) {
  ...
  CSSPlugin2.cascadeTo = function(target, duration, vars) {
    var tween = TweenLite.to(target, duration, vars), results = [tween], b = [], e = [], targets = [], _reservedProps = TweenLite._internals.reservedProps, i2, difs, p4, from;
...
var AttrPlugin = _gsScope._gsDefine.plugin({
  ...
  init: function(target, value, tween, index) {
    ...
    for (p3 in value) {
      ...
      this._addTween(target, "setAttribute", target.getAttribute(p3) + "", end + "", p3, false, p3);
      this._overwriteProps.push(p3);
    }
    return true;
  }
});
...
var _getRoundFunc = function(v) {
  var p3 = v < 1 ? Math.pow(10, (v + "").length - 2) : 1;
  return function(n) {
    return (Math.round(n / v) * v * p3 | 0) / p3;
  };
};
var _roundLinkedList = function(node, mod) {
  while (node) {
    if (!node.f && !node.blob) {
...
p._onInitAllProps = function() {
  var tween = this._tween, rp = tween.vars.roundProps, lookup = {}, rpt = tween._propLookup.roundProps, pt, next, i, p3;
  if (typeof rp === "object" && !rp.push) {
    for (p3 in rp) {
      lookup[p3] = _getRoundFunc(rp[p3]);
    }
  } else {
    if (typeof rp === "string") {
      rp = rp.split(",");
  ...
  for (p3 in lookup) {
    ...
    while (pt) {
      ...
      if (pt.pg) {
        ...
        if (pt.f === 2 && pt.t) {
          _roundLinkedList(pt.t._firstPT, lookup[p3]);
        } else {
          this._add(pt.t, p3, pt.s, pt.c, lookup[p3]);
          if (next) {
            next._prev = pt._prev;
          }
          if (pt._prev) {
...
p._add = function(target, p3, s, c, mod) {
  this._addTween(target, p3, s, s + c, p3, mod || Math.round);
  this._overwriteProps.push(p3);
};
...
var DirectionalRotationPlugin = _gsScope._gsDefine.plugin({
  ...
  init: function(target, value, tween, index) {
    ...
    this.finals = {};
    var cap = value.useRadians === true ? Math.PI * 2 : 360, min = 1e-6, p3, v, start, end, dif, split;
    for (p3 in value) {
      if (p3 !== "useRadians") {
        end = value[p3];
        if (typeof end === "function") {
        ...
        split = (end + "").split("_");
        v = split[0];
        start = parseFloat(typeof target[p3] !== "function" ? target[p3] : target[p3.indexOf("set") || typeof target["get" + p3.substr(3)] !== "function" ? p3 : "get" + p3.substr(3)]());
        end = this.finals[p3] = typeof v === "string" && v.charAt(1) === "=" ? start + parseInt(v.charAt(0) + "1", 10) * Number(v.substr(2)) : Number(v) || 0;
        dif = end - start;
        if (split.length) {
          v = split.join("_");
          if (v.indexOf("short") !== -1) {
        ...
        if (dif > min || dif < -min) {
          this._addTween(target, p3, start, start + dif, p3);
          this._overwriteProps.push(p3);
        }
      }
    }
...
var cubicToQuadratic = function(a, b, c, d) {
...
var _calculateControlPoints = function(a, curviness, quad, basic, correlate) {
  var l = a.length - 1, ii = 0, cp1 = a[0].a, i, p1, p22, p3, seg, m1, m2, mm, cp2, qb, r1, r2, tl;
  for (i = 0; i < l; i++) {
    seg = a[ii];
    p1 = seg.a;
    p22 = seg.d;
    ...
    if (correlate) {
      ...
      m1 = p22 - (p22 - p1) * (basic ? curviness * 0.5 : r1 !== 0 ? tl / r1 : 0);
      m2 = p22 + (p3 - p22) * (basic ? curviness * 0.5 : r2 !== 0 ? tl / r2 : 0);
      mm = p22 - (m1 + ((m2 - m1) * (r1 * 3 / (r1 + r2) + 0.5) / 4 || 0));
    } else {
      m1 = p22 - (p22 - p1) * curviness * 0.5;
      m2 = p22 + (p3 - p22) * curviness * 0.5;
      mm = p22 - (m1 + m2) / 2;
    }
    m1 += mm;
    m2 += mm;
    ...
    seg.ba = cp1 - p1;
    if (quad) {
      qb = cubicToQuadratic(p1, cp1, cp2, p22);
...
var _parseAnchors = function(values, p3, correlate, prepend) {
  var a = [], l, i, p1, p22, p32, tmp;
  if (prepend) {
    values = [prepend].concat(values);
    i = values.length;
    while (--i > -1) {
      if (typeof (tmp = values[i][p3]) === "string") {
        if (tmp.charAt(1) === "=") {
          values[i][p3] = prepend[p3] + Number(tmp.charAt(0) + tmp.substr(2));
        }
      }
    }
  }
  l = values.length - 2;
  if (l < 0) {
    a[0] = new Segment(values[0][p3], 0, 0, values[0][p3]);
    return a;
  }
  for (i = 0; i < l; i++) {
    p1 = values[i][p3];
    ...
    if (correlate) {
      ...
      _r2[i] = (_r2[i] || 0) + (p32 - p22) * (p32 - p22);
    }
  }
  a[i] = new Segment(values[i][p3], 0, 0, values[i + 1][p3]);
  return a;
};
var bezierThrough = function(values, curviness, quadratic, basic, correlate, prepend) {
  var obj = {}, props = [], first = prepend || values[0], i, p3, a, j, r, l, seamless, last;
  ...
  if (values.length > 1) {
    ...
    while (--i > -1) {
      p3 = props[i];
      if (Math.abs(first[p3] - last[p3]) > 0.05) {
        seamless = false;
        break;
      }
    }
  ...
  while (--i > -1) {
    p3 = props[i];
    _corProps[p3] = correlate.indexOf("," + p3 + ",") !== -1;
    obj[p3] = _parseAnchors(values, p3, _corProps[p3], prepend);
  }
  i = _r1.length;
  while (--i > -1) {
  ...
  while (--i > -1) {
    p3 = props[i];
    a = obj[p3];
    _calculateControlPoints(a, curviness, quadratic, basic, _corProps[p3]);
    if (seamless) {
      a.splice(0, j);
...
var _parseBezierData = function(values, type, prepend) {
  type = type || "soft";
  var obj = {}, inc = type === "cubic" ? 3 : 2, soft = type === "soft", props = [], a, b, c, d, cur, i, j, l, p3, cnt, tmp;
  if (soft && prepend) {
    values = [prepend].concat(values);
  }
  ...
  while (--i > -1) {
    ...
    l = values.length;
    for (j = 0; j < l; j++) {
      a = prepend == null ? values[j][p3] : typeof (tmp = values[j][p3]) === "string" && tmp.charAt(1) === "=" ? prepend[p3] + Number(tmp.charAt(0) + tmp.substr(2)) : Number(tmp);
      if (soft) {
        if (j > 1) {
          if (j < l - 1) {
...
var _addCubicLengths = function(a, steps, resolution) {
  var inc = 1 / resolution, j = a.length, d, d1, s, da, ca, ba, p3, i, inv, bez, index;
  while (--j > -1) {
    bez = a[j];
    s = bez.a;
    da = bez.d - s;
    ...
    for (i = 1; i <= resolution; i++) {
      p3 = inc * i;
      inv = 1 - p3;
      d = d1 - (d1 = (p3 * p3 * da + 3 * inv * (p3 * ca + inv * ba)) * p3);
      index = j * resolution + i - 1;
      steps[index] = (steps[index] || 0) + d * d;
    }
  }
};
var _parseLengthData = function(obj, resolution) {
  resolution = resolution >> 0 || 6;
  var a = [], lengths = [], d = 0, total = 0, threshold = resolution - 1, segments = [], curLS = [], p3, i, l, index;
  for (p3 in obj) {
    _addCubicLengths(obj[p3], a, resolution);
  }
  l = a.length;
  for (i = 0; i < l; i++) {
    d += Math.sqrt(a[i]);
...
var BezierPlugin = _gsScope._gsDefine.plugin({
  ...
  init: function(target, vars, tween) {
    ...
    var values = vars.values || [], first = {}, second = values[0], autoRotate = vars.autoRotate || tween.vars.orientToBezier, p3, isFunc, i, j, prepend;
    ...
    while (--i > -1) {
      p3 = this._props[i];
      this._overwriteProps.push(p3);
      isFunc = this._func[p3] = typeof target[p3] === "function";
      first[p3] = !isFunc ? parseFloat(target[p3]) : target[p3.indexOf("set") || typeof target["get" + p3.substr(3)] !== "function" ? p3 : "get" + p3.substr(3)]();
      if (!prepend) {
        if (first[p3] !== values[0][p3]) {
          prepend = first;
        }
      }
    }
    this._beziers = vars.type !== "cubic" && vars.type !== "quadratic" && vars.type !== "soft" ? bezierThrough(values, isNaN(vars.curviness) ? 1 : vars.curviness, false, vars.type === "thruBasic", vars.correlate, prepend) : _parseBezierData(values, vars.type, first);
    this._segCount = this._beziers[p3].length;
    if (this._timeRes) {
    ...
    if (autoRotate = this._autoRotate) {
      ...
      while (--i > -1) {
        for (j = 0; j < 3; j++) {
          p3 = autoRotate[i][j];
          this._func[p3] = typeof target[p3] === "function" ? target[p3.indexOf("set") || typeof target["get" + p3.substr(3)] !== "function" ? p3 : "get" + p3.substr(3)] : false;
        }
        p3 = autoRotate[i][2];
        this._initialRotations[i] = (this._func[p3] ? this._func[p3].call(this._target) : this._target[p3]) || 0;
        this._overwriteProps.push(p3);
      }
    }
  ...
  //called each time the values should be updated, and the ratio gets passed as the only parameter (typically it's a value between 0 and 1, but it can exceed those when using an ease like Elastic.easeOut or Back.easeOut, etc.)
  set: function(v) {
    var segments = this._segCount, func = this._func, target = this._target, notStart = v !== this._startRatio, curIndex, inv, i, p3, b, t, val, l, lengths, curSeg, v1;
    if (!this._timeRes) {
    ...
    while (--i > -1) {
      p3 = this._props[i];
      b = this._beziers[p3][curIndex];
      val = (t * t * b.da + 3 * inv * (t * b.ca + inv * b.ba)) * t + b.a;
      if (this._mod[p3]) {
        val = this._mod[p3](val, target);
      }
      if (func[p3]) {
        target[p3](val);
      } else {
...
BezierPlugin._cssRegister = function() {
  ...
  _internals._registerComplexSpecialProp("bezier", { parser: function(t, e, prop, cssp, pt, plugin) {
    ...
    var values = e.values, l = values.length - 1, pluginValues = [], v = {}, i, p3, data;
    if (l < 0) {
      return pt;
    }
    for (i = 0; i <= l; i++) {
...
p2._kill = function(lookup) {
  var a = this._props, p3, i;
  for (p3 in this._beziers) {
    if (p3 in lookup) {
      delete this._beziers[p3];
      delete this._func[p3];
      i = a.length;
      while (--i > -1) {
        if (a[i] === p3) {
          a.splice(i, 1);
...
_gsScope._gsDefine("easing.Back", ["easing.Ease"], function() {
  var w = _gsScope.GreenSockGlobals || _gsScope, gs = w.com.greensock, _2PI = Math.PI * 2, _HALF_PI = Math.PI / 2, _class = gs._class, _create = function(n, f) {
    ...
    p4.constructor = C;
    p4.getRatio = f;
    p4.config = function(overshoot) {
      return new C(overshoot);
    };
    return C;
  }, Back2 = _wrap(
    "Back",
    _createBack("BackOut", function(p4) {
      return (p4 = p4 - 1) * p4 * ((this._p1 + 1) * p4 + this._p1) + 1;
    }),
    _createBack("BackIn", function(p4) {
      return p4 * p4 * ((this._p1 + 1) * p4 - this._p1);
    }),
    _createBack("BackInOut", function(p4) {
      return (p4 *= 2) < 1 ? 0.5 * p4 * p4 * ((this._p2 + 1) * p4 - this._p2) : 0.5 * ((p4 -= 2) * p4 * ((this._p2 + 1) * p4 + this._p2) + 2);
    })
  ...
  }, true), p3 = SlowMo2.prototype = new Ease(), SteppedEase2, ExpoScaleEase2, RoughEase2, _createElastic;
  p3.constructor = SlowMo2;
  p3.getRatio = function(p4) {
    var r = p4 + (0.5 - p4) * this._p;
    if (p4 < this._p1) {
      return this._calcEnd ? 1 - (p4 = 1 - p4 / this._p1) * p4 : r - (p4 = 1 - p4 / this._p1) * p4 * p4 * p4 * r;
    } else if (p4 > this._p3) {
      return this._calcEnd ? p4 === 1 ? 0 : 1 - (p4 = (p4 - this._p3) / this._p1) * p4 : r + (p4 - r) * (p4 = (p4 - this._p3) / this._p1) * p4 * p4 * p4;
    }
    return this._calcEnd ? 1 : r;
  };
  SlowMo2.ease = new SlowMo2(0.7, 0.7);
  p3.config = SlowMo2.config = function(linearRatio, power, yoyoMode) {
  ...
  p3 = SteppedEase2.prototype = new Ease();
  p3.constructor = SteppedEase2;
  p3.getRatio = function(p4) {
    if (p4 < 0) {
      p4 = 0;
    } else if (p4 >= 1) {
    ...
    return ((this._p2 * p4 | 0) + this._p3) * this._p1;
  };
  p3.config = SteppedEase2.config = function(steps, immediateStart) {
  ...
  p3 = ExpoScaleEase2.prototype = new Ease();
  p3.constructor = ExpoScaleEase2;
  p3.getRatio = function(p4) {
    if (this._ease) {
      p4 = this._ease.getRatio(p4);
    }
    return (this._p3 * Math.exp(this._p1 * p4) - this._p3) / this._p2;
  };
  p3.config = ExpoScaleEase2.config = function(start, end, ease) {
  ...
  p3 = RoughEase2.prototype = new Ease();
  p3.constructor = RoughEase2;
  p3.getRatio = function(p4) {
    var pnt = this._prev;
    if (p4 > pnt.t) {
      while (pnt.next && p4 >= pnt.t) {
        pnt = pnt.next;
      }
      pnt = pnt.prev;
    } else {
      while (pnt.prev && p4 <= pnt.t) {
        pnt = pnt.prev;
      }
    }
    this._prev = pnt;
    return pnt.v + (p4 - pnt.t) / pnt.gap * pnt.c;
  };
  p3.config = function(vars) {
    return new RoughEase2(vars);
  };
  RoughEase2.ease = new RoughEase2();
  _wrap(
    "Bounce",
    _create("BounceOut", function(p4) {
      if (p4 < 1 / 2.75) {
        return 7.5625 * p4 * p4;
      } else if (p4 < 2 / 2.75) {
        return 7.5625 * (p4 -= 1.5 / 2.75) * p4 + 0.75;
      } else if (p4 < 2.5 / 2.75) {
        return 7.5625 * (p4 -= 2.25 / 2.75) * p4 + 0.9375;
      }
      return 7.5625 * (p4 -= 2.625 / 2.75) * p4 + 0.984375;
    }),
    _create("BounceIn", function(p4) {
      if ((p4 = 1 - p4) < 1 / 2.75) {
        return 1 - 7.5625 * p4 * p4;
      } else if (p4 < 2 / 2.75) {
        return 1 - (7.5625 * (p4 -= 1.5 / 2.75) * p4 + 0.75);
      } else if (p4 < 2.5 / 2.75) {
        return 1 - (7.5625 * (p4 -= 2.25 / 2.75) * p4 + 0.9375);
      }
      return 1 - (7.5625 * (p4 -= 2.625 / 2.75) * p4 + 0.984375);
    }),
    _create("BounceInOut", function(p4) {
      var invert = p4 < 0.5;
      if (invert) {
        p4 = 1 - p4 * 2;
      } else {
      ...
      if (p4 < 1 / 2.75) {
        ...
        p4 = 7.5625 * (p4 -= 1.5 / 2.75) * p4 + 0.75;
      } else if (p4 < 2.5 / 2.75) {
        p4 = 7.5625 * (p4 -= 2.25 / 2.75) * p4 + 0.9375;
      } else {
        p4 = 7.5625 * (p4 -= 2.625 / 2.75) * p4 + 0.984375;
      }
      return invert ? (1 - p4) * 0.5 : p4 * 0.5 + 0.5;
    })
  );
  _wrap(
    "Circ",
    _create("CircOut", function(p4) {
      return Math.sqrt(1 - (p4 = p4 - 1) * p4);
    }),
    _create("CircIn", function(p4) {
      return -(Math.sqrt(1 - p4 * p4) - 1);
    }),
    _create("CircInOut", function(p4) {
      return (p4 *= 2) < 1 ? -0.5 * (Math.sqrt(1 - p4 * p4) - 1) : 0.5 * (Math.sqrt(1 - (p4 -= 2) * p4) + 1);
    })
  );
  _createElastic = function(n, f, def) {
    ...
    p4.constructor = C;
    p4.getRatio = f;
    p4.config = function(amplitude, period) {
  ...
  _wrap(
    "Elastic",
    _createElastic("ElasticOut", function(p4) {
      return this._p1 * Math.pow(2, -10 * p4) * Math.sin((p4 - this._p3) * this._p2) + 1;
    }, 0.3),
    _createElastic("ElasticIn", function(p4) {
      return -(this._p1 * Math.pow(2, 10 * (p4 -= 1)) * Math.sin((p4 - this._p3) * this._p2));
    }, 0.3),
    _createElastic("ElasticInOut", function(p4) {
      return (p4 *= 2) < 1 ? -0.5 * (this._p1 * Math.pow(2, 10 * (p4 -= 1)) * Math.sin((p4 - this._p3) * this._p2)) : this._p1 * Math.pow(2, -10 * (p4 -= 1)) * Math.sin((p4 - this._p3) * this._p2) * 0.5 + 1;
    }, 0.45)
  );
  _wrap(
    "Expo",
    _create("ExpoOut", function(p4) {
      return 1 - Math.pow(2, -10 * p4);
    }),
    _create("ExpoIn", function(p4) {
      return Math.pow(2, 10 * (p4 - 1)) - 1e-3;
    }),
    _create("ExpoInOut", function(p4) {
      return (p4 *= 2) < 1 ? 0.5 * Math.pow(2, 10 * (p4 - 1)) : 0.5 * (2 - Math.pow(2, -10 * (p4 - 1)));
    })
  );
  _wrap(
    "Sine",
    _create("SineOut", function(p4) {
      return Math.sin(p4 * _HALF_PI);
    }),
    _create("SineIn", function(p4) {
      return -Math.cos(p4 * _HALF_PI) + 1;
    }),
    _create("SineInOut", function(p4) {
      return -0.5 * (Math.cos(Math.PI * p4) - 1);
    })
  );
...
var TweenMax2 = TweenMax;
TweenMax2._autoActivated = [TimelineLite, TimelineMax, CSSPlugin, AttrPlugin, BezierPlugin, RoundPropsPlugin, DirectionalRotationPlugin, Back, Elastic, Bounce, RoughEase, SlowMo, SteppedEase, Circ, Expo, Sine, ExpoScaleEase];
export {
  AttrPlugin,
  Back,
  BezierPlugin,
  ...
  TimelineMax,
  TweenLite,
  TweenMax2 as TweenMax,
  TweenPlugin,
  _gsScope,
  TweenMax2 as default
};
